...
class DefaultApi
{
    ...
    {
        $request = $this->downloadDocumentRequest($applicant_id, $document_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function downloadDocumentAsync($applicant_id, $document_id)
    {
        return $this->downloadDocumentAsyncWithHttpInfo($applicant_id, $document_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function downloadDocumentAsyncWithHttpInfo($applicant_id, $document_id)
    {
        $returnType = '\SplFileObject';
        $request = $this->downloadDocumentRequest($applicant_id, $document_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function downloadDocumentRequest($applicant_id, $document_id)
    {
        // verify the required parameter 'applicant_id' is set
        if ($applicant_id === null || (is_array($applicant_id) && count($applicant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $applicant_id when calling downloadDocument'
            );
        }
     ...
     * @throws \Onfido\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Onfido\Model\GenericAddressesList|\Onfido\Model\Error
     */
     ...
     * @throws \Onfido\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Onfido\Model\GenericAddressesList|\Onfido\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function findAddressesWithHttpInfo($postcode)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Onfido\Model\GenericAddressesList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Onfido\Model\GenericAddressesList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\Onfido\Model\GenericAddressesList';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Onfido\Model\GenericAddressesList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Onfido\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Onfido\Model\CheckWithReportIds|\Onfido\Model\Error
     */
     ...
     * @throws \Onfido\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Onfido\Model\CheckWithReportIds|\Onfido\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function findCheckWithHttpInfo($applicant_id, $check_id)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Onfido\Model\CheckWithReportIds' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Onfido\Model\CheckWithReportIds', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\Onfido\Model\CheckWithReportIds';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Onfido\Model\CheckWithReportIds',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $request = $this->findDocumentRequest($applicant_id, $document_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findDocumentAsync($applicant_id, $document_id)
    {
        return $this->findDocumentAsyncWithHttpInfo($applicant_id, $document_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findDocumentAsyncWithHttpInfo($applicant_id, $document_id)
    {
        $returnType = '\Onfido\Model\Document';
        $request = $this->findDocumentRequest($applicant_id, $document_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function findDocumentRequest($applicant_id, $document_id)
    {
        // verify the required parameter 'applicant_id' is set
        if ($applicant_id === null || (is_array($applicant_id) && count($applicant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $applicant_id when calling findDocument'
            );
        }
        // verify the required parameter 'document_id' is set
        if ($document_id === null || (is_array($document_id) && count($document_id) === 0)) {
     ...
     *
     * @param  string $report_type_group_id report_type_group_id (required)
     *
     * @throws \Onfido\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Onfido\Model\ReportTypeGroup|\Onfido\Model\Error
     */
     ...
     * @throws \Onfido\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Onfido\Model\ReportTypeGroup|\Onfido\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function findReportTypeGroupWithHttpInfo($report_type_group_id)
    {
        $request = $this->findReportTypeGroupRequest($report_type_group_id);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Onfido\Model\ReportTypeGroup' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Onfido\Model\ReportTypeGroup', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\Onfido\Model\ReportTypeGroup';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
    ...
    /**
     * Operation findReportTypeGroupAsync
     *
     * Retrieve single report type group object
     *
     * @param  string $report_type_group_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findReportTypeGroupAsync($report_type_group_id)
    {
        return $this->findReportTypeGroupAsyncWithHttpInfo($report_type_group_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation findReportTypeGroupAsyncWithHttpInfo
     *
     * Retrieve single report type group object
     *
     * @param  string $report_type_group_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findReportTypeGroupAsyncWithHttpInfo($report_type_group_id)
    {
        $returnType = '\Onfido\Model\ReportTypeGroup';
        $request = $this->findReportTypeGroupRequest($report_type_group_id);
    ...
    /**
     * Create request for operation 'findReportTypeGroup'
     *
     * @param  string $report_type_group_id (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function findReportTypeGroupRequest($report_type_group_id)
    {
        // verify the required parameter 'report_type_group_id' is set
        if ($report_type_group_id === null || (is_array($report_type_group_id) && count($report_type_group_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $report_type_group_id when calling findReportTypeGroup'
            );
        }
        ...
        if ($report_type_group_id !== null) {
            $resourcePath = str_replace(
                ...
                ObjectSerializer::toPathValue($report_type_group_id),
                $resourcePath
            );
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function generateSdkTokenRequest($sdk_token_request)
    {
     ...
     */
    public function listChecks($applicant_id, $page = 1, $per_page = 20)
    {
     ...
     */
    public function listChecksWithHttpInfo($applicant_id, $page = 1, $per_page = 20)
    {
        $request = $this->listChecksRequest($applicant_id, $page, $per_page);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listChecksAsync($applicant_id, $page = 1, $per_page = 20)
    {
        return $this->listChecksAsyncWithHttpInfo($applicant_id, $page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listChecksAsyncWithHttpInfo($applicant_id, $page = 1, $per_page = 20)
    {
        $returnType = '\Onfido\Model\ChecksList';
        $request = $this->listChecksRequest($applicant_id, $page, $per_page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listChecksRequest($applicant_id, $page = 1, $per_page = 20)
    {
        // verify the required parameter 'applicant_id' is set
        if ($applicant_id === null || (is_array($applicant_id) && count($applicant_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Onfido\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Onfido\Model\ReportTypeGroupsList|\Onfido\Model\Error
     */
     ...
     * @throws \Onfido\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Onfido\Model\ReportTypeGroupsList|\Onfido\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function listReportTypeGroupsWithHttpInfo()
    {
        $request = $this->listReportTypeGroupsRequest();
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Onfido\Model\ReportTypeGroupsList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Onfido\Model\ReportTypeGroupsList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\Onfido\Model\ReportTypeGroupsList';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Onfido\Model\ReportTypeGroupsList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation listReportTypeGroupsAsync
     *
     * Retrieve all report type groups
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listReportTypeGroupsAsync()
    {
        return $this->listReportTypeGroupsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listReportTypeGroupsAsyncWithHttpInfo
     *
     * Retrieve all report type groups
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listReportTypeGroupsAsyncWithHttpInfo()
    {
        $returnType = '\Onfido\Model\ReportTypeGroupsList';
        $request = $this->listReportTypeGroupsRequest();
    ...
    /**
     * Create request for operation 'listReportTypeGroups'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listReportTypeGroupsRequest()
    {
    ...
    protected function uploadDocumentRequest($applicant_id, $type, $file, $side = null, $issuing_country = null)
    {
        ...
        if ($file !== null) {
            $multipart = true;
            $formParams['file'] = Psr7Utils::tryFopen(ObjectSerializer::toFormValue($file), 'rb');
        }
        // form params
        if ($side !== null) {
